...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<Note> dbnotes = dbhandler.getAllNotes();

        final NoteListAdapter aa = new NoteListAdapter(this, android.R.layout.simple_list_item_1, dbnotes);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (noteName != null && noteText != null){
                    Note curNote = dbhandler.createNote(noteName, noteText);
                    title.setText("");
                    note.setText("");
                    aa.insert(curNote,0);
